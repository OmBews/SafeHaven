...
const Hero = () => {
  ...
  const privatesaleStartTimeStamp = 1652209200;
  const privatesaleEndTimeStamp = 1652814000;
  ...
  return (
    <PageHeader>
      ...
      <Flex>
        ...
        <StyledLink
          color="#ffbc00"
          href="https://bscscan.com/address/0x9caE753B661142aE766374CEFA5dC800d80446aC/"
          target="_blank"
        >
      ...
      <Flex>
        ...
        <StyledLink
          color="#ffbc00"
          href="https://safehavendapp.com/"
          target="_blank"
        >
          https://safehavendapp.com/
        </StyledLink>
      </Flex>
      <Flex>
        <StyledTitle color="text" mr="16px">
