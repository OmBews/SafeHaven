...
const safeHavenTextLists = [
  ...
  },
  {
    ...
    text: "Holding Haven Tokens gives you daily automatic Eth reward depending on volume. The reward is auto distributed into your wallet as ETH BEP-20, which serves as a profit without selling your tokens. 8% of buy/sell taxes go to the holder’s Ethereum reward pool.",
  },
  {
    image: Marketing,
    title: (
    ...
    <div>
      ...
      >
        ...
        <Flex justifyContent="center" flexWrap="wrap" mb="16px">
          ...
          <Button
            as={Link}
            href="https://pancakeswap.finance/swap?outputCurrency=0x4fb888204C992F222f8a10fabf6353B5d0DB660E"
            target="_blank"
            className={classes.explorerButton}
            mx="8px"
            mb="16px"
        ...
        <div>
          ...
          <ContractText fontWeight="bold" color="textColor">
            0x4fb888204C992F222f8a10fabf6353B5d0DB660E
          </ContractText>
        </div>
      </PageHeader>
      <CompanyLogo />
      ...
      >
        ...
        <video
          ...
          muted
          loop
          className="earn-eth-passively-video"
        >
